...
function CrecimientoComponent_td_44_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const row_r44 = ctx.$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](2, 1, row_r44.grsxsilo[0], "1.0-3"));
    }
}
...
function CrecimientoComponent_td_47_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const row_r45 = ctx.$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](2, 1, row_r45.grsxsilo[1], "1.0-3"));
    }
}
...
function CrecimientoComponent_td_50_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const row_r46 = ctx.$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](2, 1, row_r46.entregado, "1.0-3"), " ");
    }
}
...
let CrecimientoComponent = /*@__PURE__*/ (() => {
    class CrecimientoComponent {
        constructor(_blucontrolService, _jaulaService, _excelService, _alimentacionService, _planService, datePipe) {
            ...
            this.nombreArchivoExcel = 'iofish_crecimiento';
        ...
        generarTablaComprimida() {
            ...
            for (let j of this.jaulasTodas) {
                ...
                itemExcel = {
                    ...
                    silo1: uniqueSilo[0],
                    silo2: uniqueSilo[1],
                    grsxsilo1: entregaPorSilo[0],
                    grsxsilo2: entregaPorSilo[1],
                    visitas: visitas,
                    maxppm: maxppm,
                    minppm: minppm,
                    promppm: ppmProm,
        ...
        exportarExcel() {
            ...
            var usuario = ['Usuario', 'Puerto Fonck'];
            var hoy = new Date();
            var fechaHoy = hoy.getDate() + '/' + (hoy.getMonth() + 1) + '/' + hoy.getFullYear();
            ...
            var hora = ['Hora', hoy.getHours() + ':' + hoy.getMinutes() + ':' + hoy.getSeconds()];
            var titulo = ['Titulo', this.nombreArchivoExcel];
            var encabezado = ['Jaula', 'Horario Alimentacion', 'Silo I', 'Silo II', 'Kg x Silo I', 'Kg x Silo II', 'Numero Visitas', 'Tasa Max (PPM)', 'Tasa Min (PPM)', 'Tasa Promedio (PPM)', 'PPV Promedio', 'Kilos Entregados', 'Dieta I', 'Dieta II', 'Observacion'];
            datos = this.datosExcel.slice();
            datos.unshift(encabezado);
